...
class ModelArguments:
    ...
    freeze_llm: bool = field(
        default=False, metadata={"help": "Set to True to freeze the LLM. Default is False."}
    )
    freeze_backbone: bool = field(
        default=False, metadata={"help": "Set to True to freeze the ViT. Default is False."}
    )
    freeze_mlp: bool = field(
        default=False, metadata={"help": "Set to True to freeze the MLP. Default is False."}
    )
    ...
    use_llm_lora: int = field(
        default=0, metadata={"help": "Set the LoRA adapter rank for the LLM. Default is 0."}
    )
    ...
    drop_path_rate: float = field(
        default=0.0, metadata={"help": "Set the drop path rate for the ViT. Default is 0."}
    )
...
class DataTrainingArguments:
    ...
    min_num_frame: int = field(
        default=8, metadata={"help": "The minimum number of frames for video data. Default is 8."}
    )
    max_num_frame: int = field(
        default=32, metadata={"help": "The maximum number of frames for video data. Default is 32."}
    )
    ...
    log_freq: int = field(
        default=1000, metadata={"help": "The log frequency of the packed dataset. Default is 1000."}
    )
    ...
    loss_reduction: str = field(
        default="token", metadata={"help": "Loss reduction method. Default is token."}
    )
...
def main():
    ...
    replace_train_sampler()
    replace_train_dataloader()
    print("\033[31m" + os.environ["CUDA_VISIBLE_DEVICES"] + "\033[0m")
