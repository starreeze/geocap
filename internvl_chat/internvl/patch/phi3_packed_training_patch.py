...
from internvl.model.phi3.modeling_phi3 import PHI3_ATTENTION_CLASSES, Phi3FlashAttention2
...
class Phi3FlashAttention2ForPackedTraining(Phi3FlashAttention2):
    ...
    def _flash_attention_forward(
        ...
        with torch.no_grad():
            max_seqlen = max(
                [cu_seqlens[idx + 1] - cu_seqlens[idx] for idx in range(cu_seqlens.size(0) - 1)]
            ).item()
