...
class FlashAttention(nn.Module):
    ...
    def forward(
        self, qkv, key_padding_mask=None, causal=False, cu_seqlens=None, max_s=None, need_weights=False
    ):
...
NORM2FN = {"rms_norm": InternRMSNorm, "layer_norm": nn.LayerNorm}
...
class InternVisionEncoder(nn.Module):
    ...
    def forward(
        self, inputs_embeds, output_hidden_states: Optional[bool] = None, return_dict: Optional[bool] = None
...
class InternVisionModel(PreTrainedModel):
    ...
    def forward(
        ...
        encoder_outputs = self.encoder(
            inputs_embeds=hidden_states, output_hidden_states=output_hidden_states, return_dict=return_dict
        )
