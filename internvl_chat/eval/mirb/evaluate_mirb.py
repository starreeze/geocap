...
ds_collections = {"MIRB": {"root": "data/MIRB", "max_new_tokens": 512, "min_new_tokens": 1, "split": "test"}}
...
class MIRBDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, root, split, input_size=224, dynamic_image_size=False, use_thumbnail=False, max_num=6):
    ...
    for ds_name in args.datasets:
        ...
        for _, (pixel_values, questions, answers, num_patches_lists, lines) in tqdm(enumerate(dataloader)):
            ...
            for question, pred, answer, line in zip(questions, preds, answers, lines):
                task = line["task"]
                line = {"question": question, "prediction": pred, "answers": answer, "task": task}
