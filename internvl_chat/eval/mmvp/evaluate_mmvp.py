...
ds_collections = {"MMVP": {"root": "data/MMVP", "max_new_tokens": 100, "min_new_tokens": 1}}
...
class MMVPDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        self, root, prompt, input_size=224, dynamic_image_size=False, use_thumbnail=False, max_num=6
    ):
