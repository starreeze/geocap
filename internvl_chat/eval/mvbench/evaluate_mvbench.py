...
data_list = {
    ...
    "Action Prediction": (
        ...
        "./data/MVBench/video/star/Charades_v1_480/",
        "video",
        True,
    ),
    # has start & end
    ...
    "Fine-grained Action": (
        ...
        "./data/MVBench/video/Moments_in_Time_Raw/videos/",
        "video",
        False,
    ),
    ...
    "Object Existence": (
        ...
        "./data/MVBench/video/clevrer/video_validation/",
        "video",
        False,
    ),
    "Object Interaction": (
    ...
    "Episodic Reasoning": (
        ...
        "./data/MVBench/video/tvqa/frames_fps3_hq/",
        "frame",
        True,
    ),
...
class MVBenchDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        self.decord_method = {"video": self.read_video, "gif": self.read_gif, "frame": self.read_frame}
        self.prompt = prompt
...
def evaluate_chat_model():
    ...
    for _, (pixel_values, questions, answers, num_patches_lists, task_types) in tqdm(enumerate(dataloader)):
        ...
        outputs.append({"question": questions[0], "pred": pred, "gt": answers[0], "task_type": task_types[0]})
