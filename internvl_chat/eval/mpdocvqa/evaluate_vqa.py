        ...
        if self.dynamic_image_size:
            ...
            for image in image_list:
                tiles = dynamic_preprocess(
                    image, image_size=self.input_size, use_thumbnail=self.use_thumbnail, max_num=max_num
                )
                images += tiles
...
def evaluate_chat_model():
    ...
    for ds_name in args.datasets:
        ...
        outputs = []
        for _, (pixel_values, questions, question_ids, annotations, num_patches_lists) in tqdm(
        ...
        if torch.distributed.get_rank() == 0:
            ...
            if ds_collections[ds_name]["metric"] == "anls":
                ...
                print(
                    "python eval/mpdocvqa/infographicsvqa_eval.py -g "
