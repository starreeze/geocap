...
def evaluate_chat_model():
    ...
    for ds_name in args.datasets:
        ...
        for _, (pixel_values, questions_old, questions, answers, data_ids) in tqdm(enumerate(dataloader)):
            ...
            for question, pred, answer, data_id, question_old in zip(
                questions, preds, answers, data_ids, questions_old
            ):
                outputs.append(
                    {"question": question_old, "answer": pred, "gt_answers": answer, "id": data_id}
                )
