...
def main():
    path = "internvl_chat/work_dirs/foscap/stage3_only_new"
    output_path = "./outputs/stage3_only_new_no_force.jsonl"

    test_path = "/home/nfs05/xiangch/geocap/dataset/paraphrase_deepseek/stage3_internvl_test.jsonl"
