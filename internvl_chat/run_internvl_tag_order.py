...
def main():
    path = "/home/nfs05/models/internvl_2.5/InternVL/internvl_chat/work_dirs/foscap/stage3_only_latest"
    os.makedirs("internvl_chat/outputs", exist_ok=True)
    output_path = "internvl_chat/outputs/stage3_only_latest.jsonl"
