...
python llava/eval/eval_qwen_review_bench.py \
    ...
    --model-path path/to/Qwen-2.5-14B-Instruct

python llava/eval/summarize_qwen_review.py -f playground/data/eval/llava-bench-in-the-wild/reviews/llava-v1.5-13b.jsonl