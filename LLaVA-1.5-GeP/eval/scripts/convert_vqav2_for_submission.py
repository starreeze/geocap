...
if __name__ == "__main__":
    ...
    src = os.path.join("./LLaVA-1.5-GeP/eval/result/vqav2", "answers", args.split, args.ckpt, "merge_1.jsonl")
    ...
    dst = os.path.join(
        "./LLaVA-1.5-GeP/eval/result/vqav2", "answers_upload_1", args.split, f"{args.ckpt}.json"
    )
