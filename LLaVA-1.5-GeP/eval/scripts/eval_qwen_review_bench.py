...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--max-tokens", type=int, default=1024, help="maximum number of tokens produced in the output"
    )
    parser.add_argument("--model-path", type=int, default=1024, help="the path to qwen2.5-14b-instruct")
    ...
    for ques_js, ans1_js, ans2_js in zip(f_q, f_ans1, f_ans2):
        ...
        if idx >= len(cur_reviews):
            review = generate(model, tokenizer, content)
            print(review)
