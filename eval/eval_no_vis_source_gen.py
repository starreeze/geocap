...
from common.args import fossil_eval_args, vqa_args
...
from common.vllm.InternVL2_5 import GenerateModel
...
def main():
    ...
    user_prompt0 = [
        (
            "text",
            """Example1:
User: The following is an image of a paleontological fossil, please provide a detailed description for the fossil image. The resolution of the fossil image is 641\u00d7325, and the width and height of the image are 7.051 mm and 3.575 mm, respectively.""",
        ),
