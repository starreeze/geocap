...
try:
    ...
    _import_structure["modeling_qwen2vlm"] = ["Qwen2vlmForConditionalGeneration", "Qwen2vlmPreTrainedModel"]
...
if TYPE_CHECKING:
    ...
    try:
        ...
        from .modeling_qwen2vlm import Qwen2vlmForConditionalGeneration, Qwen2vlmPreTrainedModel
