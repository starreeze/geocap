...
def vis_mask(image, mask):
    ...
    white_mask = np.ones_like(image) * 128
...
def inference_single_image(ref_image, tar_image, tar_mask, ddim_steps, scale, seed, enable_shape_control):
    if seed == -1:
        seed = np.random.randint(10000)
    pred, depth_pred = infer_single(
        ref_image,
        tar_image,
        tar_mask,
        seed,
...
with gr.Blocks() as demo:
    with gr.Column():
        ...
        with gr.Row():
            ...
            with gr.Accordion("Advanced Option", open=True):
                ...
                enable_shape_control = gr.Checkbox(
                    label="Keep the original shape", value=False, interactive=True
                )
    ...
    with gr.Row():
        gr.Examples(
            examples=[
                ["./demo_example/005_source.png", "./demo_example/005_reference.png", 0],
                ["./demo_example/004_source.png", "./demo_example/004_reference.png", 0],
                ["./demo_example/000_source.png", "./demo_example/000_reference.png", 0],
                ["./demo_example/003_source.png", "./demo_example/003_reference.png", 0],
                ["./demo_example/006_source.png", "./demo_example/006_reference.png", 0],
                ["./demo_example/001_source.png", "./demo_example/001_reference.png", 1],
                ["./demo_example/002_source.png", "./demo_example/002_reference.png", 1],
                ["./demo_example/007_source.png", "./demo_example/007_reference.png", 1],
                ["./demo_example/008_source.png", "./demo_example/008_reference.png", 1],
            ],
            inputs=[base, ref, enable_shape_control],
    ...
    run_local_button.click(
        fn=run_local,
        inputs=[base, ref, ddim_steps, scale, seed, enable_shape_control],
