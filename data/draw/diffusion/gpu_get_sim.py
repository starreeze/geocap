...
from shape_filter_gpu import getMostSimilarImagesGPU, size_
...
def get_best_match_wrapper(data_dict):
    return getMostSimilarImagesGPU(
        data_dict["pool_prefix"], data_dict["img"], data_dict["bbox"], n=1, max_sample=99999
    )[0][0]
...
if __name__ == "__main__":
    ...
    with open(args.save_path, "w") as f:
        ...
        if multi_proc2:
            ...
            for bs in tqdm(basic_shapes):
                best_refs_poles.append(
                    {
                        "best_ref": get_best_match_wrapper(
                            {
                                "pool_prefix": pool_prefix,
                                "img": bs,
                                "bbox": samples[index]["numerical_info"]["fossil_bbox"],
        ...
        json.dump(best_refs_poles, f, ensure_ascii=False, indent=4)
